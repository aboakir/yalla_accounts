...
class _RegisterUserScreenState extends ConsumerState<RegisterUserScreen> {
  ...
  Widget _stepBody() {
    switch (_step) {
      ...
      case 1:
        return _CardSection(
          title: '2/4 — رقم الهاتف',
          subtitle:
              'أدخل رقم الهاتف الأساسي لمالك المنشأة. التحقق عبر SMS يجب أن يتم من خلال الخادم الموثوق.',
          children: [
            _field(_phone, 'رقم الهاتف', Icons.phone_outlined,
                keyboard: TextInputType.phone),
            const _InfoBanner(
                text:
                    'لأمان الحساب، لا يتم إنشاء رمز تحقق محلي داخل الجهاز بدل خدمة SMS الموثوقة.'),
          ],
        );
      case 2:
        return _CardSection(
