...
class SyncFoundationTables {
  ...
  static const documents = <String, String>{
    ...
    'inventory_items_master': 'inventory_item',
    'inventory_warehouses': 'inventory_warehouse',
    'inventory_movements': 'inventory_movement',
    'inventory_item_alternatives': 'inventory_item_alternative',
    'inventory_item_compatibility': 'inventory_item_compatibility',
