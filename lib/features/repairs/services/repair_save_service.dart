  ...
  static Future<String> save({
    ...
    await DBService.inTx((txn) async {
      ...
      final repair = Repair(
        ...
        status: isLedgerEnabled ? 'APPROVED' : 'QUOTE',
        quoteNumber: null,
        quoteValidUntil: null,
        approvedAt: isLedgerEnabled ? DateTime.now() : null,
        approvedBy: isLedgerEnabled ? 'SYSTEM' : null,
        ...
        finalApprovedAmount: isLedgerEnabled ? grandTotal : null,
