...
void main() {
  ...
  test(
    'SEC.008 migrates live DB v66 to v67 without credential rewrites',
    () async {
    ...
    skip: (Platform.environment['YALLA_SEC008_LIVE_DB_PATH']?.trim().isEmpty ??
            true)
        ? 'Historical fixture test; set YALLA_SEC008_LIVE_DB_PATH explicitly to run'
        : false,
  );
}
