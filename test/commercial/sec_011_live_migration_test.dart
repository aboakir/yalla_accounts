...
void main() {
  ...
  test(
    'SEC.011 upgrades live client DB to v68 without rewriting history',
    () async {
    ...
    skip: (Platform.environment['YALLA_SEC011_LIVE_DB_PATH']?.trim().isEmpty ??
            true)
        ? 'Historical fixture test; set YALLA_SEC011_LIVE_DB_PATH explicitly to run'
        : false,
  );
}
