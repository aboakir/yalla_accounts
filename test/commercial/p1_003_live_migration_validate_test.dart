  ...
  test(
    ...
    () async {
      ...
      try {
        ...
        stdout.writeln('P1.003 live migration validation PASS.');
        stdout.writeln('Database upgraded to current version: PASS');
        stdout.writeln('Historical GL unchanged: PASS');
        stdout.writeln('Historical invoice totals unchanged: PASS');
        stdout.writeln('Historical ILS facts preserved: PASS');
        stdout.writeln('Next payment voucher sequence P-0056: PASS');
      } finally {
        await db.close();
      }
    },
