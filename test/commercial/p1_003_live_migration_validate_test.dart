...
void main() {
  test('P1.003 live v59 to v60 preserves history', () async {
    sqfliteFfiInit();
    ...
    try {
      expect(i(await db.rawQuery('PRAGMA user_version')), 60);
      ...
      expect(n(glAfter.first['cr']), closeTo(n(glBefore.first['cr']), 0.0001));
