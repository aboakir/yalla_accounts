...
void main() {
  ...
  test(
    'SEC.007 migrates live DB v65 to v66 without credential rewrites',
    () async {
    ...
    skip: (Platform.environment['YALLA_SEC007_LIVE_DB_PATH']?.trim().isEmpty ??
            true)
        ? 'Historical fixture test; set YALLA_SEC007_LIVE_DB_PATH explicitly to run'
        : false,
  );
}
