...
void main() {
  ...
  test(
    'SEC.005 migrates live DB v63 to v64 without historical rewrites',
    () async {
    ...
    skip: (Platform.environment['YALLA_SEC005_LIVE_DB_PATH']?.trim().isEmpty ??
            true)
        ? 'Historical fixture test; set YALLA_SEC005_LIVE_DB_PATH explicitly to run'
        : false,
  );
}
