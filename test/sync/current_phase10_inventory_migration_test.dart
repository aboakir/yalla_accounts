...
void main() {
  ...
  test(
    'Phase 20 v81 to v83 preserves v82 inventory migration without outbound noise',
    () async {
      ...
      try {
        ...
        await db.execute(
          'DROP VIEW IF EXISTS ${InventoryTables.stockByItemView}',
        );
        await db.execute(
          'DROP TABLE IF EXISTS ${InventoryTables.alternatives}',
        );
        await db.execute(
          'DROP TABLE IF EXISTS ${InventoryTables.compatibility}',
        );
