...
void main() {
  ...
  testWidgets('payroll reports fit Windows 1280x800 with canonical data',
      (tester) async {
    ...
    await tester.runAsync(() async {
      ...
      dir = await Directory.systemTemp.createTemp('payroll_windows_');
      db = await DatabaseMigration.initDatabase(
        pathOverride: p.join(dir.path, 'windows.db'),
      );
      ...
      await EmployeeDatabaseService.insert(Employee.fromMap({
        ...
        'full_name': 'موظف اختبار الرواتب على ويندوز',
