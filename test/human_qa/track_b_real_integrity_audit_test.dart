...
void main() {
  ...
  test('B12 real-data integrity has no unexplained financial mismatch',
    ...
    try {
      final repairIssues = await RepairHistoricalReconciliationService.audit(db);
      ...
      final payload = <String, Object?>{
        ...
        'repair_issues_explained': repairIssues.length - repairableIssues.length,
        ...
        'unexplained_active_invoice_without_gl': unexplainedActiveInvoiceWithoutGl,
        ...
        'explained_repair_issues':
            repairIssues.where((x) => !x.repairable).map((x) => x.toJson()).toList(),
      };
